...
const SearchModal = ({ open, onClose }) => {
    ...
    return (
        <div className={`search-modal fixed top-0 left-0 w-full h-full flex justify-center items-center ${open ? "block" : "hidden"} bg-black bg-opacity-70 z-50`}>
            <div className="search-modal-content bg-formColor p-12 rounded-lg w-96">
                ...
                <form onSubmit={handleSubmit} className="mt-8">
                    ...
                    <button className="search-btn w-full mt-8 bg-accent text-white py-2 rounded-md hover:bg-opacity-80 focus:outline-none focus:bg-opacity-80" type="submit">
                        Search
                    </button>
                </form>
                <button className="search-close-btn w-full mt-2 bg-gray-600 text-white py-2 rounded-md hover:bg-opacity-80 focus:outline-none focus:bg-opacity-80" onClick={handleClose}>
                    Close
                </button>
            </div>
        </div>
